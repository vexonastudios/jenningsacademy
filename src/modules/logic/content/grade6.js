const grade6 = [
  ...
  },
  {
    ...
    "scenario": "You say 2+2=4, but you learned that from a bad teacher, so it must be false! (Extra)",
    "audioText": "You say 2 plus 2 is 4, but you learned that from a bad teacher, so it must be false!",
    "options": [
      {
        "text": "Genetic Fallacy",
  ...
  {
    "type": "missing-piece",
    "scenario": "I studied for exactly one minute, so I will get an A. (Extra)",
    "audioText": "I studied for exactly one minute, so I will get an A.",
    "question": "What is missing?",
    "options": [
      {
  ...
  {
    "type": "fair-unfair",
    "scenario": "He wants to eat healthier. You say: So you want to starve to death?! (Extra)",
    "audioText": "He wants to eat healthier. You say: So you want to starve to death?!",
    "options": [
      {
        "text": "Straw Man",
  ...
  {
    "type": "contradiction-hunt",
    "scenario": "1: I am entirely mute. 2: I am speaking out loud. (Extra)",
    "audioText": "1: I am entirely mute. 2: I am speaking out loud.",
    "options": [
      {
        "text": "They conflict (Contradiction)",
  ...
  },
  {
    ...
    "scenario": "If I drop this pencil, the school will explode! (Extra)",
    "audioText": "If I drop this pencil, the school will explode!",
    "options": [
      {
        "text": "Slippery Slope",
  ...
  {
    "type": "missing-piece",
    "scenario": "I have wheels, so I have a car. (Extra)",
    "audioText": "I have wheels, so I have a car.",
    "question": "What's missing?",
    "options": [
      {
  ...
  {
    "type": "fair-unfair",
    "scenario": "You don't want to go to the movie. Friend: You hate me! (Extra)",
    "audioText": "You don't want to go to the movie. Friend: You hate me!",
    "options": [
      {
        "text": "Unfair response",
  ...
  {
    "type": "contradiction-hunt",
    "scenario": "1: Water is completely dry. 2: Water is wet. (Extra)",
    "audioText": "1: Water is completely dry. 2: Water is wet.",
    "options": [
      {
        "text": "Contradiction",
